...
g.add_argument("--output",type=str, default=f'output/fold0.json',  help="output filename")
...
g.add_argument("--peft_model_dir", type=str, default="./output/fold0/checkpoint-2040",help="peft_model_dir")
